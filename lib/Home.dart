import 'package:HEvent/favorite/favorite.dart';
import 'package:HEvent/srearch/search.dart';
            ...
            //  selectedItemColor: Color(0xFFFD4F99),
              ...
              items: <FancyBottomNavigationItem>[
                FancyBottomNavigationItem(
                    icon: Icon(Icons.home,color: Color(0xFFFD4F99) ), title: Text('Home',style: TextStyle(color: Color(0xFFFD4F99)),)),
                FancyBottomNavigationItem(
                    icon: Icon(Icons.notifications,color: Color(0xFFFD4F99)), title: Text('notifications',style: TextStyle(color: Color(0xFFFD4F99)))),
                FancyBottomNavigationItem(
                    icon: Icon(Icons.person_outline,color: Color(0xFFFD4F99)), title: Text('profile',style: TextStyle(color: Color(0xFFFD4F99)))),
                FancyBottomNavigationItem(
                    icon: Icon(Icons.favorite,color: Color(0xFFFD4F99)), title: Text('favorite',style: TextStyle(color: Color(0xFFFD4F99)))),
                FancyBottomNavigationItem(
                    icon: Icon(Icons.search,color: Color(0xFFFD4F99)), title: Text('search',style: TextStyle(color: Color(0xFFFD4F99)))),
              ],
