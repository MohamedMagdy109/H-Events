  ...
  Future getdata() async {
    ...
    if (name != "" && name != null) {
      ...
      QuerySnapshot qn = await firestore
          .collection('Events')
          .where("trakName", isEqualTo: widget.type)
          .where("placePrice" , isLessThanOrEqualTo: int.parse(widget.budget))
                      ...
                      onTap: () async {
                        ...
                        Navigator.of(context)
                          ...
                          return new placeInfo(
                            images: document["images"], title: document["placeName"],
                           ...
                           // date: document["date"], status: document["status"],
                            docID: document.documentID, userID: document['PlaceOwnerId'],
