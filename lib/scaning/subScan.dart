...
import 'package:HEvent/scaning/attenndes.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter_barcode_scanner/flutter_barcode_scanner.dart';
import './subAttendess.dart';
import './subScanpage.dart';


class SubScan extends StatefulWidget {
  String eventTitle;
  SubScan({this.eventTitle});
  @override
  _ScanPageState createState() => _ScanPageState();
}

class _ScanPageState extends State<SubScan> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            .push(MaterialPageRoute(builder: (context) =>SubScanPage() ));
          },
        ),
        title: Text('Scan',
            style: TextStyle(
      ...
      actions: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              ...
              MaterialPageRoute(builder: (context)=>Attenneds()));
